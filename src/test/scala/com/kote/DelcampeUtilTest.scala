...
import com.kote.model.Price
import com.kote.scrapper.DelcampeUtil
import com.kote.validation.{InvalidBidQuantityFormat, InvalidDateFormat, InvalidPriceFormat, InvalidShortDateFormat}
